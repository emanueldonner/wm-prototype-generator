...
<wm-header color="wasserblau" role="banner">
	<div slot="header">
		<a href="/" data-demo="false">{$siteName}</a>
		<a href="/">
			<svg viewBox="0 0 311 142" width="80" aria-hidden="true" focusable="false"
				><path
					class="wm-logo__image"
					fill="#FF0000"
